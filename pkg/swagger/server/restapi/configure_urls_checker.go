...
//go:generate swagger generate server --target ../../server --name UrlsChecker --spec ../../swagger.yml --principal interface{} --exclude-main

func configureFlags(api *operations.UrlsCheckerAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.UrlsCheckerAPI) http.Handler {
